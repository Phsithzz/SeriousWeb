...
const ProductBrand = ({brand}) => {
  ...
  return (
    ...
    <div className="p-2">
        ...
        <h1 className="text-3xl text-left font-bold mb-4 bg-black text-white w-fit p-4 rounded-xl transitio ease-in duration-200 hover:bg-white hover:border-2 cursor-pointer hover:text-black">{brand}</h1>
        </div>
           ...
           >
             <div className="flex justify-center items-center  ">
               <img
                 ...
                 }/img_products/${brands.image_filename}.jpg`}
                 alt={brands.name}
